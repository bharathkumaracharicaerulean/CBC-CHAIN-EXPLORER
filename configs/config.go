...
import (
	...
	xtime "github.com/itering/cbcscan/pkg/time"
...
func (_ *Mysql) mergeDefaultDSNs(a, b *url.URL) (*url.URL, error) {
	...
	dbPath := valueOrDefaultStr("cbcscan-essentials", getDBNameOfDSN(a), getDBNameOfDSN(b))
...
func (p *Postgres) mergeEnvironment() {
	...
	p.DBName = valueOrDefaultStr("cbcscan-essentials", p.DBName, os.Getenv("POSTGRES_DB"))
