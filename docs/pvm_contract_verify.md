# Tutorial: Deploy and Verify Smart Contract using Remix & cbcscan
...
## Step 5: Verify on CBCScan
1. Go to [CBCScan](https://assethub-westend.cbcscan.io/verify_contract) (or other network explorer)
