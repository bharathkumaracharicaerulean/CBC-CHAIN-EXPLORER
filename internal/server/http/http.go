...
import (
	...
	"github.com/itering/cbcscan/configs"
	middlewares "github.com/itering/cbcscan/internal/middleware"
	"github.com/itering/cbcscan/internal/service"
	"github.com/itering/cbcscan/plugins"
	customValidator "github.com/itering/cbcscan/util/validator"
	netHttp "net/http"
	"time"
)
...
func initRouter(e *gin.Engine) {
	...
	g := e.Group("/api")
	{
		...
		s := g.Group("/scan")
		{
			...
			// CBC Extensions
			s.POST("cbc/validators", cbcValidatorsHandle)
			s.GET("cbc/validators", cbcValidatorsHandle)
			s.POST("cbc/dcf", cbcDCFHandle)
